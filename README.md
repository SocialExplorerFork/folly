...
it from https://github.com/SocialExplorerFork/googletest/archive/release-1.8.0.tar.gz
The following commands can be used to download and install it:

```
wget https://github.com/SocialExplorerFork/googletest/archive/release-1.8.0.tar.gz && \
